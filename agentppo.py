...
def train(episodes=2000):
    ...
    base_env = ChefsHatEnv()

    # Patch missing attribute to avoid AttributeError
    if not hasattr(base_env, "logDirectory"):
        base_env.logDirectory = ""   # ← ADD THIS LINE

    base_env.episodeNumber = 0   # ← already in your code
